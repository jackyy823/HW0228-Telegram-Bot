...
import logging
from telegram import ReplyKeyboardMarkup, ReplyKeyboardRemove, Update, ReplyKeyboardMarkup
...
NAME, GENDER, LOCATION, BIO = range(4)
user_data = {}
...
def bio(update: Update, context: CallbackContext) -> int:
    ...
    user_data[BIO] = update.message.text
...
def main() -> None:
    ...
    # Create data in db
    database = "C:/Users/Jacky/Repo/HW0228-Telegram-Bot/content.sqlite"
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            NAME: [MessageHandler(Filters.regex('^(Boy|Girl|Other)$'), gender)],
            GENDER: [MessageHandler(Filters.photo, photo), CommandHandler('skip', skip_photo)],
            LOCATION: [
    ...
    # for name, _handler in conv_handler.name:
